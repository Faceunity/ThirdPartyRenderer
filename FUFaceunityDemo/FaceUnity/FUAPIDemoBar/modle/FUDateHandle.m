...
/// 返回美肤模型
/// @param valueDictData 美肤参数字典
+ (NSArray<FUBeautyParam *>*)setupSkinDataWithValueDict:(NSDictionary *)valueDictData{
    ...
    for (NSString *str in prams) {
        ...
        modle.mValue = [[valueDictData valueForKey:str] floatValue];
...
+ (NSArray<FUBeautyParam *>*)setupShapDataWithValueDict:(NSDictionary *)valueDict{
   ...
   for (NSString *str in prams) {
       ...
       modle.mParam = str;
       modle.mTitle = [titelDic valueForKey:str];
       modle.mValue = [[valueDict valueForKey:str] floatValue];
       modle.defaultValue = modle.mValue;
